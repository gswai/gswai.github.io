...
L.marker([45.5016889, -73.56725599999999], {icon: gswaiIcon}).addTo(mymap).bindPopup('<b>Startup Weekend AI 2018</b><br /> Montreal, Canada').openPopup();
...
L.marker([33.886917, 9.537499000000025], {icon: gswaiIcon}).addTo(mymap).bindPopup('<b>Startup Weekend AI 2018</b><br />Carthage, Tunisia');
